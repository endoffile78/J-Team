<%@ Page Title="" Language="C#" MasterPageFile="~/new_main_master.Master" AutoEventWireup="true" CodeBehind="EagleConnect.aspx.cs" Inherits="main_master.EagleConnect" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_place_holder_body" runat="server">
    ...
    <div class="col-md-4">
      <img src="Images/archie.jpg" class="card-img responsive" alt="Responsive image">
    </div>
    <div class="col-md-8 intern-card">
      <div class="card-body">
        <h5 class="card-title">ARCHIBALD T. EAGLE</h5>
        <p>Senior | Computer Science | Ralph Lauren | Brand Planning Intern | Manhattan, New York</p>
        <p class="card-text">
        ...
        <div class="card mb-3" style="max-width: 100%;">
              <div class="row no-gutters">
    <div class="col-md-4">
      <img src="Images/archie2.jpg" class="card-img" alt="Responsive image">
    </div>
    <div class="col-md-8 intern-card">
      <div class="card-body">
        <h5 class="card-title">ARCHIBALD T. EAGLE</h5>
        ...
        <div class="card mb-3" style="max-width: 100%;">
             <div class="row no-gutters">
    <div class="col-md-4">
      <img src="Images/archie3.jpg" class="card-img" alt="Responsive image">
    </div>
    <div class="col-md-8 intern-card">
      <div class="card-body">
        <h5 class="card-title">ARCHIBALD T. EAGLE</h5>
