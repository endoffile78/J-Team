...
(
 [VpostID]    uniqueidentifier NOT NULL ,
 [Email]      nvarchar(50) NOT NULL ,
 [ID_Num]     uniqueidentifier NOT NULL ,
 ...
 CONSTRAINT [PK_Vote_Post] PRIMARY KEY CLUSTERED ([VpostID] ASC),
 CONSTRAINT [FK_211] FOREIGN KEY ([Email], [ID_Num])  REFERENCES [dbo].[User_Main]([Email], [ID_Num])
);
GO


CREATE NONCLUSTERED INDEX [fkIdx_211] ON [Vote_Post] 
 (
  [Email] ASC, 
  [ID_Num] ASC
 )
...
(
 ...
 CONSTRAINT [PK_Options] PRIMARY KEY CLUSTERED ([VpostID] ASC),
 CONSTRAINT [FK_222] FOREIGN KEY ([VpostID])  REFERENCES [Vote_Post]([VpostID])
);
GO


CREATE NONCLUSTERED INDEX [fkIdx_222] ON [Options] 
 (
  [VpostID] ASC
 )
